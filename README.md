...
<video src="assets/demo.mp4" autoplay loop muted playsinline width="100%" aria-label="Hermia demo: running 28 structured behavioral evaluations across models including llama3.2 and qwen3:8b, comparing pass/fail results per test on a local Ollama fleet">Download the <a href="assets/demo.mp4">demo video</a>.</video>
